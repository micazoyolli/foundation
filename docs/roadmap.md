...
<div class="principle-grid">
  <div class="principle-card"><strong>Foundation Core</strong><span>Entrypoints TypeScript y SCSS públicados en npm.</span></div>
...
- SEO metadata específica de proyectos.
- Smoke harness compartido.
- Binder de protección de media.
...
- tiene una API fácil de documentar;
- reduce código local;
